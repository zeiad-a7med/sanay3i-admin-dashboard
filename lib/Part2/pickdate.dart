...
import 'package:maintenanceservices/Models/ordertime.dart';
import '../cards/daycard.dart';
import '../main.dart';
import 'orderdetails.dart';
import '../cards/timeslotcard.dart';
...
class PickDate extends StatefulWidget{
  ...
  PickDate(this.iconImg,this.category,this.selectedService,);
  @override
  State<PickDate> createState() => _PickDateState(iconImg,category,selectedService,dayName,currentMonth,currentDay);
}
...
class _PickDateState extends State<PickDate> {
  ...
  int selectedTime=0;
  _PickDateState(this.iconImg,this.category,this.selectedService,this.dayName,this.currentMonth,this.currentDay);
  @override
                          ...
                          child:Container(
                            ...
                            child: ElevatedButton(
                                ...
                                onPressed:(selectedTime==0||selectedDay==0||selectedDayName=="")? null: (){
                                  ...
                                  orderTime.SelectedDay=selectedDay.toString();
                                  orderTime.SelectedDayName=selectedDayName;
                                  orderTime.SelectedMonth=selectedMonth;
                                  orderTime.SelectedTime=selectedTime;
                                  Navigator.push(context, MaterialPageRoute(builder: (context) => OrderDetails("",category,selectedService,orderTime)));
                                },
