...
class AcceptedOrder extends StatefulWidget{
  Requests request;
  AcceptedOrder(this.request);

  @override
  State<AcceptedOrder> createState() => _AcceptedOrderState(request);
}
...
class _AcceptedOrderState extends State<AcceptedOrder> {
  ...
  _AcceptedOrderState(this.request);
  @override
                                              ...
                                              child: Padding(
                                                ...
                                                child:Column(
                                                  children: [
                                                    ...
                                                    Text("${request.state}",style: TextStyle(color: Colors.green),),
                                                  ],
                                                ),
                                              ),
                                            ),
                            ...
                            child:ElevatedButton(
                                ...
                                onPressed: () async {
                                  ...
                                  if(request.isArrived == "No"){
                                    ...
                                    Navigator.pushReplacement( context , new MaterialPageRoute(builder: (context) => new MyOrders()) );
                                  }else{
                                    return showDialog<void>(
                                      ...
                                      builder: (BuildContext context) {
                                        return AlertDialog(
                                          title: const Text("You Can't Cancel The Order Now!"),
                                          actions: <Widget>[
                                            TextButton(
                                              child: const Text('Ok'),
                                              onPressed: () {
